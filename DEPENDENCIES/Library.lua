...
local library = {
    version = "beta",
    title = title or "eyevan " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "player"
}
...
function library:Introduction()
    ...
    xsxLogo.Size = UDim2.new(0, 500, 0, 400)
    xsxLogo.Visible = true
    xsxLogo.Image = "http://www.roblox.com/asset/?id=123717817554744"
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                end
            end
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleButton.MouseEnter:Connect(function()
                TweenService:Create(toggleLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Text = ""
                textBoxValues.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                textboxFrame.MouseEnter:Connect(function()
                    TweenService:Create(textboxLabel, TweenTable["TextBox"], {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                end)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                        end
                    end
