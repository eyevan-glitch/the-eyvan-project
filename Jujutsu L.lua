...
local LoadingXSX = Notif:Notify("Loading eyevan lib, please be patient.", 5, "information") 

library.title = "EYEVAN : Beta"
...
local FinishedLoading = Notif:Notify("Loaded EYEVAN Beta", 4, "success")
